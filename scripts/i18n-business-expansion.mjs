...
const medical = {
  ...
  '訪日外国人のお客様が日本で安心して受診できるよう、受診内容に関する情報提供、医療機関との日程調整、通訳・翻訳を含む多言語案内、空港・ホテル・医療機関間の移動支援を行います。': t('訪日外国人のお客様が日本で安心して受診できるよう、受診内容に関する情報提供、医療機関との日程調整、通訳・翻訳を含む多言語案内、空港・ホテル・医療機関間の移動支援を行います。', '为帮助访日旅客安心在日本就诊，我们提供就诊相关信息、医疗机构日程协调、包含口译与笔译的多语言说明，以及机场、酒店与医疗机构之间的交通支持。', 'To help international visitors access care in Japan with confidence, we provide appointment information, scheduling support with medical providers, multilingual guidance including interpretation and translation, and transportation between airports, hotels and medical facilities.', '방일 외국인 고객이 일본에서 안심하고 진료를 받을 수 있도록 진료 관련 정보 제공, 의료기관 일정 조정, 통역·번역을 포함한 다국어 안내, 공항·호텔·의료기관 간 이동을 지원합니다.', '為協助訪日旅客安心在日本就診，我們提供就診相關資訊、醫療機構日程協調、包含口譯與筆譯的多語言說明，以及機場、飯店與醫療機構之間的交通支援。'),
  '受診目的、希望日程、同行人数、使用言語を確認し、医療機関からの案内に沿って、必要な移動、宿泊、滞在スケジュールを一体で整理します。': t('受診目的、希望日程、同行人数、使用言語を確認し、医療機関からの案内に沿って、必要な移動、宿泊、滞在スケジュールを一体で整理します。', '我们会确认就诊目的、希望日期、同行人数和使用语言，并依据医疗机构的说明，统一整理交通、住宿和在日行程。', 'We confirm the purpose of the visit, preferred dates, party size and language, then coordinate transportation, accommodation and the stay schedule in line with the medical provider’s guidance.', '진료 목적, 희망 일정, 동행 인원과 사용 언어를 확인한 뒤 의료기관의 안내에 따라 이동, 숙박 및 체류 일정을 통합적으로 조정합니다.', '我們會確認就診目的、希望日期、同行人數和使用語言，並依據醫療機構的說明，統一整理交通、住宿和在日行程。'),
  '医療ツーリズムでご相談いただけること': t('医療ツーリズムでご相談いただけること', '可咨询的医疗旅游支持', 'Medical tourism support available', '의료 관광 지원 상담 항목', '可洽詢的醫療旅遊支援'),
  '人間ドック・健診受診サポート': t('人間ドック・健診受診サポート', '健康检查就诊支持', 'Health Screening Support', '건강검진 진료 지원', '健康檢查就診支援'),
  '希望する健診内容や当日の流れを確認し、医療機関の案内に沿って必要な手続きと日程を整理します。': t('希望する健診内容や当日の流れを確認し、医療機関の案内に沿って必要な手続きと日程を整理します。', '确认希望进行的健康检查内容与当日流程，并依据医疗机构的说明整理所需手续和日程。', 'We confirm the requested screening and day-of process, then organise the necessary procedures and schedule in line with the medical provider’s guidance.', '희망하는 검진 내용과 당일 절차를 확인하고 의료기관 안내에 따라 필요한 수속과 일정을 정리합니다.', '確認希望進行的健康檢查內容與當日流程，並依據醫療機構的說明整理所需手續和日程。'),
  '医療情報の確認・受診調整': t('医療情報の確認・受診調整', '医疗信息确认与就诊协调', 'Medical Information and Appointment Coordination', '의료 정보 확인 및 진료 일정 조정', '醫療資訊確認與就診協調'),
  '医療機関が公開する情報をもとに、受診条件、必要書類、候補日を確認し、日程調整を支援します。': t('医療機関が公開する情報をもとに、受診条件、必要書類、候補日を確認し、日程調整を支援します。', '依据医疗机构公开的信息，确认就诊条件、所需资料和候选日期，并协助协调日程。', 'Using information published by medical providers, we confirm appointment requirements, necessary documents and potential dates, then support scheduling.', '의료기관이 공개한 정보를 바탕으로 진료 조건, 필요 서류와 후보 일정을 확인하고 일정 조정을 지원합니다.', '依據醫療機構公開的資訊，確認就診條件、所需文件和候選日期，並協助協調日程。'),
  '医療機関との連絡・情報共有': t('医療機関との連絡・情報共有', '与医疗机构联络及信息共享', 'Provider Liaison and Information Sharing', '의료기관 연락 및 정보 공유', '與醫療機構聯絡及資訊共享'),
  '受診先からの案内を確認し、お客様に必要な準備事項、集合場所、当日の連絡事項を共有します。': t('受診先からの案内を確認し、お客様に必要な準備事項、集合場所、当日の連絡事項を共有します。', '确认就诊机构提供的说明，并向客户传达所需准备事项、集合地点和当日联络信息。', 'We review guidance from the provider and share required preparation, meeting points and day-of contact information with the visitor.', '진료기관의 안내를 확인하고 고객에게 필요한 준비 사항, 집합 장소와 당일 연락 사항을 전달합니다.', '確認就診機構提供的說明，並向顧客傳達所需準備事項、集合地點和當日聯絡資訊。'),
  '通訳・翻訳・多言語案内': t('通訳・翻訳・多言語案内', '口译、笔译与多语言说明', 'Interpretation, Translation and Multilingual Guidance', '통역·번역 및 다국어 안내', '口譯、筆譯與多語言說明'),
  '受診前の確認事項や滞在中の案内を、希望言語に合わせて分かりやすくお伝えします。': t('受診前の確認事項や滞在中の案内を、希望言語に合わせて分かりやすくお伝えします。', '根据客户希望使用的语言，清晰说明就诊前确认事项与在日行程信息。', 'We explain pre-visit requirements and information for the stay clearly in the visitor’s preferred language.', '진료 전 확인 사항과 체류 중 안내를 희망 언어에 맞춰 알기 쉽게 전달합니다.', '依照顧客希望使用的語言，清楚說明就診前確認事項與在日行程資訊。'),
  '移動・宿泊手配': t('移動・宿泊手配', '交通与住宿安排', 'Transportation and Accommodation Arrangements', '이동 및 숙박 수배', '交通與住宿安排'),
  '受診予定、人数、荷物に合わせて、空港・ホテル・医療機関間の送迎と宿泊日程を調整します。': t('受診予定、人数、荷物に合わせて、空港・ホテル・医療機関間の送迎と宿泊日程を調整します。', '根据就诊日程、人数与行李情况，协调机场、酒店与医疗机构之间的接送及住宿安排。', 'We coordinate transportation between airports, hotels and medical facilities together with accommodation to suit the appointment schedule, party size and luggage.', '진료 일정, 인원과 수하물에 맞춰 공항·호텔·의료기관 간 송영과 숙박 일정을 조정합니다.', '依照就診日程、人數與行李情況，協調機場、飯店與醫療機構之間的接送及住宿安排。'),
  '滞在・観光スケジュール調整': t('滞在・観光スケジュール調整', '在日停留及观光行程协调', 'Stay and Sightseeing Schedule Coordination', '체류 및 관광 일정 조정', '在日停留及觀光行程協調'),
  '到着から受診、滞在、観光、帰国まで、体調と受診予定に配慮した無理のない行程を整理します。': t('到着から受診、滞在、観光、帰国まで、体調と受診予定に配慮した無理のない行程を整理します。', '从抵达、就诊、停留、观光到回国，协助安排兼顾身体状况与就诊日程的合理行程。', 'We organise a practical itinerary from arrival and appointments through the stay, sightseeing and departure, taking the visitor’s condition and medical schedule into account.', '도착, 진료, 체류, 관광, 귀국까지 건강 상태와 진료 일정을 고려한 무리 없는 일정을 정리합니다.', '從抵達、就診、停留、觀光到回國，協助安排兼顧身體狀況與就診日程的合理行程。'),
  ...
  '希望する受診内容、日程、人数、言語、移動・宿泊の希望を確認します。': t('希望する受診内容、日程、人数、言語、移動・宿泊の希望を確認します。', '确认希望就诊的内容、日程、人数、语言，以及交通与住宿需求。', 'We confirm the requested appointment, dates, party size, language, transportation and accommodation requirements.', '희망 진료 내용, 일정, 인원, 언어, 이동 및 숙박 요청을 확인합니다.', '確認希望就診的內容、日程、人數、語言，以及交通與住宿需求。'),
  '情報確認・日程調整': t('情報確認・日程調整', '信息确认及日程协调', 'Information Review and Scheduling', '정보 확인 및 일정 조정', '資訊確認及日程協調'),
  '医療機関からの案内に基づき、受診条件、必要書類、候補日を整理します。': t('医療機関からの案内に基づき、受診条件、必要書類、候補日を整理します。', '依据医疗机构的说明，整理就诊条件、所需资料和候选日期。', 'Based on provider guidance, we organise appointment requirements, necessary documents and potential dates.', '의료기관 안내에 따라 진료 조건, 필요 서류와 후보 일정을 정리합니다.', '依據醫療機構的說明，整理就診條件、所需文件與候選日期。'),
  '空港、ホテル、医療機関間の送迎と宿泊を、受診日程に合わせて調整します。': t('空港、ホテル、医療機関間の送迎と宿泊を、受診日程に合わせて調整します。', '根据就诊日程，协调机场、酒店与医疗机构之间的接送及住宿安排。', 'We coordinate transportation between airports, hotels and medical facilities together with accommodation around the appointment schedule.', '진료 일정에 맞춰 공항·호텔·의료기관 간 송영과 숙박을 조정합니다.', '依照就診日程，協調機場、飯店與醫療機構之間的接送及住宿安排。'),
  '通訳・当日の案内': t('通訳・当日の案内', '口译及当日说明', 'Interpretation and Day-of Guidance', '통역 및 당일 안내', '口譯及當日說明'),
  '確定した予定と連絡事項を希望言語で共有し、円滑な受診と滞在を支援します。': t('確定した予定と連絡事項を希望言語で共有し、円滑な受診と滞在を支援します。', '以客户希望使用的语言共享已确认的日程与联络事项，协助顺利完成就诊与在日行程。', 'We share the confirmed schedule and contact details in the visitor’s preferred language to support a smooth appointment and stay.', '확정된 일정과 연락 사항을 희망 언어로 공유해 원활한 진료와 체류를 지원합니다.', '以顧客希望使用的語言共享已確認的日程與聯絡事項，協助順利完成就診與在日行程。'),
  '医療行為に関するご案内': t('医療行為に関するご案内', '医疗服务相关说明', 'Important Medical Notice', '의료행위 관련 안내', '醫療服務相關說明'),
  '当社は医療機関ではなく、診断・治療等の医療行為は行いません。受診の可否、検査・治療内容、医療行為および医学的判断は、受診先の医療機関が行います。': t('当社は医療機関ではなく、診断・治療等の医療行為は行いません。受診の可否、検査・治療内容、医療行為および医学的判断は、受診先の医療機関が行います。', '本公司并非医疗机构，不实施诊断、治疗等医疗行为。能否就诊、检查与治疗内容、医疗行为及医学判断均由就诊的医疗机构负责。', 'We are not a medical provider and do not perform diagnosis, treatment or any other medical procedure. Appointment eligibility, examination and treatment details, medical care and clinical decisions are determined by the medical provider visited.', '당사는 의료기관이 아니며 진단, 치료 등 의료행위를 하지 않습니다. 진료 가능 여부, 검사·치료 내용, 의료행위와 의학적 판단은 진료를 받는 의료기관에서 결정합니다.', '本公司並非醫療機構，不實施診斷、治療等醫療行為。能否就診、檢查與治療內容、醫療行為及醫學判斷均由就診的醫療機構負責。'),
...
export const EXPANSION_SEO_DESCRIPTIONS = {
  ...
  'business-medical.html': t(
    '人間ドックや先進医療に関する情報提供、受診調整、通訳・翻訳、移動・宿泊手配を支える医療ツーリズム事業をご紹介します。',
    '介绍Daitora Group面向访日旅客提供的健康检查及先进医疗相关信息、就诊协调、口译与笔译、交通及住宿安排。',
    'Daitora Group provides medical tourism support for international visitors, including appointment information, scheduling, interpretation and translation, transportation and accommodation arrangements.',
    'Daitora Group의 건강검진 및 첨단의료 관련 정보, 진료 일정 조정, 통역·번역, 이동 및 숙박 지원을 소개합니다.',
    '介紹Daitora Group面向訪日旅客提供的健康檢查及先進醫療相關資訊、就診協調、口譯與筆譯、交通及住宿安排。'
  ),
